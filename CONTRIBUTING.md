Contributing to YEP Core
============================

The YEP Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/yep-project/yep/blob/master/doc/translation_process.md)
...
The following applies to code changes to the YEP Core project, and is not to be
confused with overall YEP Network Protocol consensus changes.

Whether a pull request is merged into YEP Core rests with the project merge
...
Patches that change YEP consensus rules are considerably more involved than
...
Where a patchset proposes to change the YEP consensus, it must have been
...
The project leader is the release manager for each YEP Core release.
