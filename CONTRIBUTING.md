...
The YEP project operates an open contributor model where anyone is
...
The following applies to code changes to the YEP project, and is not to be
confused with overall YEP Network Protocol consensus changes.

Whether a pull request is merged into YEP rests with the project merge
...
The project leader is the release manager for each YEP release.
