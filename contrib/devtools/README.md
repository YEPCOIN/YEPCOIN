...
Provides utilities for managing copyright headers of `The YEP
...
Setup
---------
Configuring the github-merge tool for the YEP repository is done in the following way:

    git config githubmerge.repository YEP-Project/YEP
...
A script to optimize png files in the YEP
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_yep: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_yep: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_yep: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_yep: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
