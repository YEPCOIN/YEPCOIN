...
License:	MIT
URL:		https://yepcoin.io/
Source0:	https://yepcoin.io/bin/YEP-%{version}/yep-%{version}.tar.gz
...
%description server
This package provides a stand-alone YEP daemon. For most users, this
package is only needed if they need a full-node without the graphical client.

Some third party wallet software will want this package to provide the actual
YEP node they use to connect to the network.

If you use the graphical YEP client then you almost certainly do not
need this package.
...
cat <<EOF > %{buildroot}%{_datadir}/applications/YEP.desktop
[Desktop Entry]
Encoding=UTF-8
Name=Bitcoin
...
touch -a -m -t 201511100546 %{buildroot}%{_datadir}/applications/YEP.desktop
%{_bindir}/desktop-file-validate %{buildroot}%{_datadir}/applications/YEP.desktop

# KDE protocol - change the touch timestamp if modifying
mkdir -p %{buildroot}%{_datadir}/kde4/services
cat <<EOF > %{buildroot}%{_datadir}/kde4/services/YEP.protocol
[Protocol]
exec=yep-qt '%u'
protocol=yep
input=none
...
touch -a -m -t 201511100546 %{buildroot}%{_datadir}/kde4/services/YEP.protocol
%endif
...
%attr(0644,root,root) %{_datadir}/applications/YEP.desktop
%attr(0644,root,root) %{_datadir}/kde4/services/YEP.protocol
...
- Rename Qt package from yep to YEP
