...
This will build yep-qt as well, if the dependencies are met.
 ...
 **For Ubuntu only:** db4.8 packages are available [here](https://launchpad.net/~yep/+archive/yep).
...
If you want to build yep-qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a yep-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip yepd" to strip the debug
