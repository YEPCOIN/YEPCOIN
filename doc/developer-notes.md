...
- [Development guidelines](#development-guidelines)
    - [General YEP Core](#general-yep-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
YEP Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
YEP Core is a multi-threaded application, and deadlocks or other
...
However, in open source software such as YEP Core, where everyone uses
...
pay attention to for reviewers of YEP Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: YEP Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against YEP Core so that they can be integrated
