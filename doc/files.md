...
yep.conf           | contains configuration settings for yepd or yep-qt
yepd.pid           | stores the process id of yepd while running
...
debug.log           | contains debug information and general logging generated by yepd or yep-qt
