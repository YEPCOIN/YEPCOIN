...
The script [extract-osx-sdk.sh](https://github.com/yep-project/yep/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
yep/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/yep-project/yep/blob/master/doc/README_osx.md) for troubleshooting tips.