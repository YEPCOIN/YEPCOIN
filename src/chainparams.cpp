...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0xf3dd68c663d6b3dc0d1d09c397feda16050e3dae47f4dac82988297c813b5afa"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1564193088, // * UNIX timestamp of last checkpoint block
...
static Checkpoints::MapCheckpoints mapCheckpointsTestnet =
    boost::assign::map_list_of
    (0, uint256("0xd5f181b98515c906a427c8f5496bb5ad2aeff887e8438db9abeacb1718e6cb36"));
...
static Checkpoints::MapCheckpoints mapCheckpointsRegtest =
    boost::assign::map_list_of(0, uint256("0xd5f181b98515c906a427c8f5496bb5ad2aeff887e8438db9abeacb1718e6cb36"));
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("02b24d8f160b7f6c0234cf4e1f07f839e9989900d1512e3ea621486550d801bebf");
        nDefaultPort = 16740;
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        bnProofOfStakeLimit = ~uint256(0) >> 16;
        bnProofOfStakeLimit_V2 = ~uint256(0) >> 16; // 60/4 = 15 ==> use 2**4 higher limit
        ...
        nLastPOWBlock = 1000;
        nYEPBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nYEPBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
        ...
        nPublicZCSpends = nLastPOWBlock + 1;
        ...
        genesis.nVersion = 7;
        genesis.nTime = 1564193088;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1482437;

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0xf3dd68c663d6b3dc0d1d09c397feda16050e3dae47f4dac82988297c813b5afa"));
        assert(genesis.hashMerkleRoot == uint256("0xcd3fda90dceba122b4639e555080334172cbf21c7fc458051a31a47f306ed262"));
        ...
        nBudgetCycleBlocks = 21600; //!< Amount of blocks in a months period of time (using 1 minutes per) = (60*24*30)
        strSporkPubKey = "02b24d8f160b7f6c0234cf4e1f07f839e9989900d1512e3ea621486550d801bebf";
        strSporkPubKeyOld = "02b24d8f160b7f6c0234cf4e1f07f839e9989900d1512e3ea621486550d801bebf";
        strObfuscationPoolDummyAddress = "YhGMk6HpFJ6SGMhEEmu2Lw2X1aqS2HrhwZ";
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zyep to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nYEPBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nYEPBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        assert(hashGenesisBlock == uint256("0xd5f181b98515c906a427c8f5496bb5ad2aeff887e8438db9abeacb1718e6cb36"));
        assert(genesis.hashMerkleRoot == uint256("0xcd3fda90dceba122b4639e555080334172cbf21c7fc458051a31a47f306ed262"));

        vFixedSeeds.clear();
        vSeeds.clear();

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet yep addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet yep script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet yep BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet yep BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet yep BIP44 coin type is '1' (All coin's testnet default)
