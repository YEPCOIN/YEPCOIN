 ...
 * YEP system. There are three: the main network on which people trade goods
...
public:
    ...
    int YEPBadBlockTime() const { return nYEPBadBlockTime; }
    int YEPBadBlocknBits() const { return nYEPBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nYEPBadBlockTime;
    unsigned int nYEPBadBlocknBits;
