...
/* YEP GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "YEP"
#define QAPP_ORG_DOMAIN "yepcoin.io"
#define QAPP_APP_NAME_DEFAULT "YEP-Qt"
#define QAPP_APP_NAME_TESTNET "YEP-Qt-testnet"
