...
/** Utility functions used by the YEP Qt UI.
 */
namespace GUIUtil
{
...
// Render YEP addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZyep = false);
...
// Parse "yep:" URI into recipient object, return true on successful parsing
