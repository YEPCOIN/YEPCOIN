                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzYEPPathCustom = GetArg("-zyepbackuppath", "");
    ...
    if(!strzYEPPathCustom.empty()) {
        ui->wallet_customzyepbackuppath->setText(QString::fromStdString(strzYEPPathCustom));
        ui->wallet_customzyepbackuppath_label->setVisible(true);
        ui->wallet_customzyepbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzYEPPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the YEP RPC console.") + "<br>" +
