...
#include "qt/yep/coincontrolyepwidget.h"
#include "qt/yep/forms/ui_coincontrolyepwidget.h"

CoinControlYEPWidget::CoinControlYEPWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlYEPWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select YEP Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("YEP");
    ...
    ui->labelValueAfter->setText("0.00 YEP");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 YEP");
    ui->labelValueFee->setText("0.00 YEP");
...
CoinControlYEPWidget::~CoinControlYEPWidget()
{
    delete ui;
}
