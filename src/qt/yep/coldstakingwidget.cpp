...
#include "qt/yep/coldstakingwidget.h"
#include "qt/yep/forms/ui_coldstakingwidget.h"
#include "qt/yep/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/yep/requestdialog.h"
#include "qt/yep/tooltipmenu.h"
#include "qt/yep/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(YEPGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your YEPs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept YEP delegation / Delegate YEP"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select YEP outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 YEP" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
