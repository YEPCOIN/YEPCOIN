...
#include "qt/yep/furabstractlistitemdelegate.h"
#include "qt/yep/txviewholder.h"
#include "qt/yep/tooltipmenu.h"
#include "qt/yep/sendmultirow.h"
#include "qt/yep/coldstakingmodel.h"
#include "qt/yep/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(YEPGUI* parent);
    ~ColdStakingWidget();
