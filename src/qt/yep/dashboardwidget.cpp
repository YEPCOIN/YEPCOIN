...
//    setCssSubtitleScreen(ui->labelMessage);
    ...
    ui->labelAmountZyep->setVisible(false);
...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &YEPGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
...
void DashboardWidget::loadWalletModel()
{
    if (walletModel && walletModel->getOptionsModel()) {
        ...
        connect(ui->pushImgEmpty, &QPushButton::clicked, window, &YEPGUI::openFAQ);
        connect(ui->btnHowTo, &QPushButton::clicked, window, &YEPGUI::openFAQ);
...
void DashboardWidget::onChartRefreshed()
{
    ...
    set0->setColor(QColor(203,153,83));
