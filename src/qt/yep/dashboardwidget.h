...
#include "config/yep-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalYep = 0;
    qint64 totalZyep = 0;
    QList<qreal> valuesYep;
    QList<qreal> valueszYep;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(YEPGUI* _window);
    ~DashboardWidget();
