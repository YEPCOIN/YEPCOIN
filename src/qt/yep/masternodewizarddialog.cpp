...
#include "qt/yep/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 16740");
    ...
    if(walletModel->isTestNetwork()){
        ...
        ui->lineEditPort->setText("16742");
    } else {
        ui->lineEditPort->setText("16740");
    }
...
bool MasterNodeWizardDialog::createMN(){
    if (walletModel) {
        ...
        SendCoinsRecipient sendCoinsRecipient(QString::fromStdString(address.ToString()), QString::fromStdString(alias), CAmount(20000) * COIN, "");
