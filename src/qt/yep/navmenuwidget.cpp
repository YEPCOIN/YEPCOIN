...
#include "qt/yep/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(YEPGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    QMovie *movie = new QMovie("://img-nav-logo-yep");

    connect(movie, &QMovie::frameChanged, [=] {
        ui->imgLogo->setIcon(movie->currentPixmap());
    });
