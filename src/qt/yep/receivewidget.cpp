...
#include "qt/yep/forms/ui_receivewidget.h"
...
#include "qt/yep/addressholder.h"
...
ReceiveWidget::ReceiveWidget(YEPGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive YEP."));
