...
#include "qt/yep/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(YEPGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &YEPGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
