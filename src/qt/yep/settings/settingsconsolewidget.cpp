...
#include "qt/yep/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/yep/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(YEPGUI* _window, QWidget *parent) :
