...
#include "qt/yep/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/yep/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(YEPGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableYEP,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableYEP,
    ...
    connect(ui->pushButton_UnspendableYEP, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableYEP);});
    ...
    if (parent)
        connect(parent, &YEPGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
