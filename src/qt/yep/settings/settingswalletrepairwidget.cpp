...
#include "qt/yep/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/yep/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(YEPGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to YEPGUI::handleRestart()
