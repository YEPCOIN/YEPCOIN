...
#include "qt/yep/settings/forms/ui_settingswidget.h"
#include "qt/yep/settings/settingsbackupwallet.h"
#include "qt/yep/settings/settingsbittoolwidget.h"
#include "qt/yep/settings/settingswalletrepairwidget.h"
#include "qt/yep/settings/settingswalletoptionswidget.h"
#include "qt/yep/settings/settingsmainoptionswidget.h"
#include "qt/yep/settings/settingsdisplayoptionswidget.h"
#include "qt/yep/settings/settingsmultisendwidget.h"
#include "qt/yep/settings/settingsinformationwidget.h"
#include "qt/yep/settings/settingsconsolewidget.h"
...
SettingsWidget::SettingsWidget(YEPGUI* parent) :
    PWidget(parent),
