...
#include "qt/yep/topbar.h"
#include "qt/yep/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/yep/lockunlock.h"
#include "qt/yep/qtutils.h"
#include "qt/yep/receivedialog.h"
...
TopBar::TopBar(YEPGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopYEP, ui->labelAmountTopzYEP}, "amount-small-topbar");
    setCssProperty({ui->labelAmountYEP, ui->labelAmountzYEP}, "amount-topbar");
    setCssProperty({ui->labelPendingYEP, ui->labelPendingzYEP, ui->labelImmatureYEP, ui->labelImmaturezYEP}, "amount-small-topbar");
...
void TopBar::updateBalances(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance,
    ...
    // YEP Total
    CAmount yepAvailableBalance = balance;
    // zYEP Balance
    CAmount matureZerocoinBalance = zerocoinBalance - unconfirmedZerocoinBalance - immatureZerocoinBalance;

    // Set
    QString totalYEP = GUIUtil::formatBalance(yepAvailableBalance, nDisplayUnit);
    QString totalzYEP = GUIUtil::formatBalance(matureZerocoinBalance, nDisplayUnit, true);
    // Top
    ui->labelAmountTopYEP->setText(totalYEP);
    ui->labelAmountTopzYEP->setText(totalzYEP);

    // Expanded
    ui->labelAmountYEP->setText(totalYEP);
    ui->labelAmountzYEP->setText(totalzYEP);

    ui->labelPendingYEP->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelPendingzYEP->setText(GUIUtil::formatBalance(unconfirmedZerocoinBalance, nDisplayUnit, true));

    ui->labelImmatureYEP->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
    ui->labelImmaturezYEP->setText(GUIUtil::formatBalance(immatureZerocoinBalance, nDisplayUnit, true));
}
