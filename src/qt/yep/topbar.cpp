...
#include "qt/yep/loadingdialog.h"
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopYep}, "amount-small-topbar");
    setCssProperty({ui->labelAmountYep}, "amount-topbar");
    setCssProperty({ui->labelPendingYep, ui->labelImmatureYep}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // PIV Total
    QString totalYep = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    ui->labelPendingYep->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance, nDisplayUnit));
    ui->labelImmatureYep->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
