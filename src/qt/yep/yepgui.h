...
#ifndef YEP_CORE_NEW_GUI_YEPGUI_H
#define YEP_CORE_NEW_GUI_YEPGUI_H
...
#include "qt/yep/navmenuwidget.h"
#include "qt/yep/topbar.h"
#include "qt/yep/dashboardwidget.h"
#include "qt/yep/send.h"
#include "qt/yep/receivewidget.h"
#include "qt/yep/addresseswidget.h"
#include "qt/yep/coldstakingwidget.h"
#include "qt/yep/masternodeswidget.h"
#include "qt/yep/snackbar.h"
#include "qt/yep/settings/settingswidget.h"
...
/**
  YEP GUI main class. This class represents the main window of the YEP UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class YEPGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit YEPGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~YEPGUI();
...
#endif //YEP_CORE_NEW_GUI_YEPGUI_H
