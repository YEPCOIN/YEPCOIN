...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* YEP features */
        {"yep", "listmasternodes", &listmasternodes, true, true, false},
        {"yep", "getmasternodecount", &getmasternodecount, true, true, false},
        {"yep", "masternodeconnect", &masternodeconnect, true, true, false},
        {"yep", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"yep", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"yep", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"yep", "masternodecurrent", &masternodecurrent, true, true, false},
        {"yep", "masternodedebug", &masternodedebug, true, true, false},
        {"yep", "startmasternode", &startmasternode, true, true, false},
        {"yep", "createmasternodekey", &createmasternodekey, true, true, false},
        {"yep", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"yep", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"yep", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"yep", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"yep", "getmasternodescores", &getmasternodescores, true, true, false},
        {"yep", "preparebudget", &preparebudget, true, true, false},
        {"yep", "submitbudget", &submitbudget, true, true, false},
        {"yep", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"yep", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"yep", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"yep", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"yep", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"yep", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"yep", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"yep", "checkbudgets", &checkbudgets, true, true, false},
        {"yep", "mnsync", &mnsync, true, true, false},
        {"yep", "spork", &spork, true, true, false},
        {"yep", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzyepseed", &getzyepseed, false, false, true},
        {"zerocoin", "setzyepseed", &setzyepseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzyep", &searchdzyep, false, false, true},
        {"zerocoin", "dzyepstate", &dzyepstate, false, false, true},
...
{
    return "> yep-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16741/\n";
}
