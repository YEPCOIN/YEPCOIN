...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIVX features */
        {"yep", "listmasternodes", &listmasternodes, true },
        {"yep", "getmasternodecount", &getmasternodecount, true },
        {"yep", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"yep", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"yep", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"yep", "masternodecurrent", &masternodecurrent, true },
        {"yep", "startmasternode", &startmasternode, true },
        {"yep", "createmasternodekey", &createmasternodekey, true },
        {"yep", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"yep", "listmasternodeconf", &listmasternodeconf, true },
        {"yep", "getmasternodestatus", &getmasternodestatus, true },
        {"yep", "getmasternodewinners", &getmasternodewinners, true },
        {"yep", "getmasternodescores", &getmasternodescores, true },
        {"yep", "preparebudget", &preparebudget, true },
        {"yep", "submitbudget", &submitbudget, true },
        {"yep", "mnbudgetvote", &mnbudgetvote, true },
        {"yep", "getbudgetvotes", &getbudgetvotes, true },
        {"yep", "getnextsuperblock", &getnextsuperblock, true },
        {"yep", "getbudgetprojection", &getbudgetprojection, true },
        {"yep", "getbudgetinfo", &getbudgetinfo, true },
        {"yep", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"yep", "mnfinalbudget", &mnfinalbudget, true },
        {"yep", "checkbudgets", &checkbudgets, true },
        {"yep", "mnsync", &mnsync, true },
        {"yep", "spork", &spork, true },
