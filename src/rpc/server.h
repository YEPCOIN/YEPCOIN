...
extern UniValue setzyepseed(const JSONRPCRequest& request);
extern UniValue getzyepseed(const JSONRPCRequest& request);
extern UniValue generatemintlist(const JSONRPCRequest& request);
extern UniValue searchdzyep(const JSONRPCRequest& request);
extern UniValue dzyepstate(const JSONRPCRequest& request);
