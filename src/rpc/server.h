...
extern UniValue DoZyepSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzyepseed(const UniValue& params, bool fHelp);
extern UniValue getzyepseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzyep(const UniValue& params, bool fHelp);
extern UniValue dzyepstate(const UniValue& params, bool fHelp);
