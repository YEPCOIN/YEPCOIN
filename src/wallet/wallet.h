...
enum WalletFeature {
    ...
    FEATURE_PRE_YEP = 61000, // inherited version..
...
enum ZerocoinSpendStatus {
    ...
    ZYEP_TXMINT_GENERAL = 9,                        // General errors in MintsToInputVectorPublicSpend
...
public:
    ...
    void doZYepRescan(const CBlockIndex* pindex, const CBlock& block, std::set<uint256>& setAddedToWallet, const Consensus::Params& consensus, bool fCheckZYEP);
    ...
    // zPIV wallet
    std::unique_ptr<CzYEPTracker> zyepTracker{nullptr};
