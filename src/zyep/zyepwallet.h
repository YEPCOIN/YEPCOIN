...
#ifndef YEP_ZYEPWALLET_H
#define YEP_ZYEPWALLET_H
...
public:
    ...
    void GenerateDeterministicZYEP(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZYEP(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
