...
"""Verify that starting yep with -h works as expected."""
import subprocess

from test_framework.test_framework import YEPTestFramework
from test_framework.util import assert_equal

class HelpTest(YEPTestFramework):
    ...
    def run_test(self):
        self.log.info("Start yep with -h for help text")
        ...
        self.log.info("Start yep with -version for version information")
