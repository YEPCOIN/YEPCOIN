...
class RawTransactionsTest(YEPTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid yep address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid yep address" in e.error['message'])
